"""Typed, redacted HTTP error responses for the GUI boundary."""
...
try:
    ...
    class ConflictError(ValueError, RuntimeError):
        """Local compatibility type for the POWER 3.7.1 core error boundary."""
...
def _http_mapping(exc: StarletteHTTPException) -> tuple[int, str, str]:
    ...
    known = {
        ...
        403: ("permission_denied", "You do not have permission to perform this operation."),
        404: ("not_found", "The requested resource was not found."),
        405: ("operation_not_allowed", "The operation is not allowed while the GUI is read-only."),
