"""PowerClient port: the single interface connecting POWER-GUI to POWER ApplicationService."""
...
class PowerClient:
    ...
    def discover(self, actor: str = "gui") -> ApplicationEnvelope:
    ...
    def get_source_stats(self, actor: str = "gui") -> SourceStatsResponse:
    ...
    def read_source(
        self, rel_path: str, max_bytes: int = 2_000_000, actor: str = "gui"
    ) -> SourceReadResponse:
    ...
    def get_task(self, task_id: str, actor: str = "gui") -> TaskDTO:
    ...
    def get_task_events(
        self, task_id: str, since_sequence: int = 0, actor: str = "gui"
    ) -> list[TaskEventDTO]:
